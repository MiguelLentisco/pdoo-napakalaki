...
module NapakalakiGame
  ...
  class CardDealer
    ...
    def initMonsterCardDeck
      ...
      # El sopor de Dunwich
      prize = Prize.new(1,1)
      bC = SpecificBadConsequence.new("El primodial bostezo " \
      ...
      # El rey de rosado
      prize = Prize.new(3, 2)
      bC = NumericBadConsequence.new("Pierdes 5 niveles y 3" \
      ...
      # Los hondos
      prize = Prize.new(2, 1)
      bC = DeathBadConsequence.new("Estos monstruos resultan bastante " \
      ...
      # Roboggoth
      prize = Prize.new(2, 1)
      bC = SpecificBadConsequence.new("La quinta directiva primaria" \
      ...
      prize = Prize.new(3, 1)
      bC = SpecificBadConsequence.new("Pierdes 1 mano visible", 0, [TreasureKind::ONEHAND], [])
      ...
      # Felpuggoth
      prize = Prize.new(1, 1)
      bC = SpecificBadConsequence.new("Pierdes tu casco y tu armadura visible." \
